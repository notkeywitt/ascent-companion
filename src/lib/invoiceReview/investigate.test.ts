...
function bill(partial: Partial<BillRef> & { id: string; cost: number }): BillRef {
  return { label: partial.id, vendor: "Sunset Builders Supply", status: "approved", invoiced: true, invoiceIds: [], sentInvoiceIds: [], issueDate: '2026-07-15', lineCount: 1, taxAmount: 0, untaxedLineCount: 0, untaxedCost: 0, qboIsIgnored: false, ...partial };
}
