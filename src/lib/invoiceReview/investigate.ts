...
const SYSTEM = [
  ...
  "   - labor-rate-stale / labor-rate-split: the finding already carries the arithmetic.",
  "     What it CANNOT know is whether the new rate was meant to apply to work already",
  "     done. Say which reading the evidence supports; do not assume a raise is backdated.",
