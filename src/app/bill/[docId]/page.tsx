    ...
    <main className="mx-auto max-w-xl px-4 pb-[calc(9rem+env(safe-area-inset-bottom))] pt-5">
      ...
      {lines && (
        <>
          ...
          <div className="mt-4 rounded-xl border border-neutral-200 bg-white p-4 dark:border-neutral-700/60 dark:bg-ink-raised">
            <dl className="ml-auto max-w-xs space-y-2 text-sm">
              ...
              <div className="flex items-baseline justify-between gap-4 border-t border-neutral-200 pt-2 dark:border-neutral-700/60">
        ...
        <div className="fixed inset-x-0 bottom-0 z-30 border-t border-neutral-200 bg-cream/95 pb-[env(safe-area-inset-bottom)] backdrop-blur dark:border-white/10 dark:bg-ink/95 print:hidden">
          <div className="mx-auto max-w-xl px-4">
            ...
            <div
              id="bill-actions"
              hidden={!drawerOpen}
              className="max-h-[45dvh] overflow-y-auto border-t border-neutral-200 py-3 dark:border-white/10"
            >
            ...
            <div
              className={`flex items-center justify-between gap-3 py-2.5 ${
                drawerOpen ? "" : "border-t border-neutral-200 dark:border-white/10"
              }`}
            >
