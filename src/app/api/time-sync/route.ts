...
// Reads the whole Time Entries sheet through Apps Script, so give it the same
// budget as the other sheet-backed routes rather than the short platform default.
