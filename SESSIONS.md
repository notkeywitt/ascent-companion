...
|---|---|---|---|---|
| [gemini-claude-transition-status](.claude/sessions/2026-09-09-gemini-claude-transition-status.md) | `claude/gemini-claude-transition-status-cib68c` | 19h ago | 1 | owner: delete GEMINI_KEY + GEMINI_MODEL from Vercel; decide whether ANTHROPIC_M… |
| [trip-recording-persistence](.claude/sessions/2026-09-08-trip-recording-persistence.md) | `claude/trip-recording-persistence-evilps` | 25h ago | 3 | verify on the phone: start a trip, force-quit the app, reopen — the trip should… |
...
|---|---|---|---|
| [jobtread-qbo-sales-tax](.claude/sessions/2026-09-05-jobtread-qbo-sales-tax.md) | 2026-09-09 | 45 | bill move: background + Drive re-file + real error; buyback picker dialog; appr… |
