...
|---|---|---|---|---|
| [ci-verify-job-failures](.claude/sessions/2026-09-06-ci-verify-job-failures.md) | `claude/ci-verify-job-failures-wcfpyk` | 47h ago | 1 | push this branch to remote main — main is still red until the Link fix lands th… |
...
|---|---|---|---|
| [jobtread-qbo-sales-tax](.claude/sessions/2026-09-05-jobtread-qbo-sales-tax.md) | 2026-09-08 | 35 | bill move: background + Drive re-file + real error; buyback picker dialog; appr… |
